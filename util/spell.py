...
client = storage.Client(project='the-project-163403')
bucket = client.get_bucket('deep_speech1')
blob = bucket.blob('data_files/datafiles.zip')
try:
    blob.download_to_filename("datafiles.zip")
except Exception:
    pass

fantasy_zip = zipfile.ZipFile('datafiles.zip')
